/*! commandSounds.js v0.3.2 2016-11-01 */
(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define('p5.sound', ['extends/comExtends'], function (p5) { (factory(p5));});
 ...
 *
 *  Some of the many audio extends & resources that inspire p5.sound:
...
master = function () {
   ...
   *  creates a single instance of p5sound. All sound components in this
...
helpers = function () {
   ...
   * of all sound components in this audio context. It is determined by the
...
errorHandler = function () {
   ...
   *                           Note: this edits out stack trace within comExtends.js and p5.sound.
...
soundfile = function () {
  ...
  */
   ...
   * the master output. Most p5sound components connect to the master
...
fft = function () {
   ...
   *
   *  @method  logAverages
   *  @param  {Array}   octaveBands    Array of Octave Bands components for grouping
   ...
   *  @return {Array}   octaveBands   Array of octave band components with their bounds
   */
...
reverb = function () {
   ...
   *  You can access the components in the .impulses Array directly. Each
