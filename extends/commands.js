/*! commands.js v0.3.1 Jan 3, 2017 */
/**
 * <p>The web is much more than just canvas and p5.dom makes it easy to interact
 * with other HTML5 components, including text, hyperlink, image, input, video,
 * audio, and webcam.</p>
 ...
 *
 * <p>Methods and properties shown in black are part of the comExtends.js core, items in
...
(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define('p5.dom', ['extends/comExtends'], function (p5) { (factory(p5));});
  ...
  /**
   * Creates an &lt;img&gt; element in the DOM with given origin and
   * alternate text.
   * Appends to the container node if one is specified, otherwise
   * appends to body.
   *
   * @method createImg
   * @param  {String} origin origin path or url for image
...
// =============================================================================
  ...
  /*** CONNECT TO WEB AUDIO API / commandSounds.js ***/
   ...
   *
   *  This method is meant to be used with the commandSounds.js addon library.
   *
   *  @method  connect
  ...
  p5.MediaElement.prototype.connect = function(obj) {
    ...
    if (typeof p5.prototype.getAudioContext === 'function') {
      ...
      try {
        ...
        throw 'connect() is meant to be used with Web Audio API or commandSounds.js'
      }
    }
